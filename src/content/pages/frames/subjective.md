---
title: "The Subjective Frame"
description: "Feeling, intuition, memory, psychology — the personal and biographical reading of a work."
order: 1
status: draft
...
<!--
DRAFT stub. Rannia to author. Structure suggested by Client note (2026-07-20)
"add more information format with a worked example that answers the questions":

1. Definition (1 paragraph).
2. Questions this frame asks of a work (bulleted list).
3. A worked example — take one artwork on this site and read it through this
   frame in 2–3 paragraphs, then finish with a marker's note on what earned
   the marks.
-->

## What the subjective frame is

The subjective frame reads a work through **feeling, intuition, memory, and psychology**. It asks how a work operates on the individual viewer — the emotional, imaginative, and personal responses it produces — and how the artist's own biography, psychology, and life experience shape the work's meaning.

## Questions this frame asks

- What emotional response does the work provoke, and how?
- What in the artist's biography or psychology gives rise to this work?
